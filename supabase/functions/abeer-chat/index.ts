  ...
  try {
    ...
    if (!reply) {
      const retry = await callNvidia(
        "جاوبي بالعربي فقط. إذا الرسالة مجرد تحية أو دردشة عفوية (مرحبا، هاي، أهلاً، كيفك، صباح الخير، شكراً، إلخ)، ردي بسطر واحد طبيعي وبشري قصير جداً (≤١٢ كلمة) بدون أي مصطلحات (مصفوفة/كود/رندرة/إزاحة/نور عمودي) وبدون أي ترويج أو سؤال قيادي، مثال: \"أهلين فيكِ 💛 شو الموضوع اللي حابة نحكي فيه؟\". لباقي الأسئلة الحقيقية: من ٣ إلى ٤ جمل (≈٤٠–٦٠ كلمة) متوسطة الطول، مباشرة وحازمة بدون حشو ولا مقدمات ولا تعداد ولا تفكير بصوت عالي ولا إنجليزي ولا تكرار للسؤال. لأول سؤالين من العميلة جاوبي فقط بدون أي سؤال قيادي. ابتداءً من السؤال الثالث، أضيفي سؤال قيادي واحد قصير جداً (≤٨ كلمات) على سطر منفصل، نوّعي صياغته ولا تبدئيه بـ \"شو أكتر شي\" أو \"شو أكثر شيء\". ابتداءً من السؤال الرابع، أضيفي سطر واحد قصير جداً بعد السؤال القيادي بصياغة قريبة من: \"إذن أنتِ بحاجة لجلسة ديكودنغ خاصة\" مع تنويع الصياغة. السعر دائماً 299$ إذا سُئل. خارج الاختصاص: ردي بالعربي إنه خارج اختصاصك.",
      );
      // @ts-ignore
