  ...
  try {
    ...
    if (!reply) {
      const retry = await callNvidia(
        "جاوبي بالعربي فقط، بثلاث جمل بالضبط، بدون أي تفكير بصوت عالي وبدون إنجليزي وبدون تكرار التعليمات. إذا السؤال مو من اختصاصك أو مو موجود بقاعدة بياناتك، ردي بالعربي إنه خارج اختصاصك.",
      );
      // @ts-ignore
