  ...
  try {
    ...
    if (!reply) {
      const retry = await callNvidia(
        "جاوبي بالعربي فقط، على الأقل ٣ جمل مع شرح بسيط وواضح بدون حشو، بدون أي تفكير بصوت عالي وبدون إنجليزي وبدون تكرار التعليمات. اختمي دائماً بسؤال قيادي قصير مرتبط بالجواب يخلّي العميلة تتعمّق بحالتها، ونوّعي صياغته في كل مرة ولا تبدئيه أبداً بـ \"شو أكتر شي\" أو \"شو أكثر شيء\"؛ استخدمي بدائل (كيف، ليش، متى، وين، إيش اللي، شو اللي بيمنعك، شو اللي بيحرّكك، شو الإحساس اللي…). إذا صار عدد ردودك السابقة بالمحادثة ٣ أو أكثر، أضيفي بعد السؤال القيادي جملة دفع لطيفة وحازمة قريبة من: \"إذن أنتِ في حاجة إلى جلسة استشارة خاصة أو ديكودنغ لفك شيفرة الوضعية التي تخصك\" مع تنويع الصياغة. إذا سألت العميلة عن السعر أو التكلفة، اذكري دائماً أن السعر 299$. إذا السؤال مو من اختصاصك أو مو موجود بقاعدة بياناتك، ردي بالعربي إنه خارج اختصاصك.",
      );
      // @ts-ignore
