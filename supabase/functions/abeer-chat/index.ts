  ...
  try {
    ...
    if (!reply) {
      const retry = await callNvidia(
        "جاوبي بالعربي فقط، على الأقل ٣ جمل مع شرح بسيط وواضح بدون حشو، بدون أي تفكير بصوت عالي وبدون إنجليزي وبدون تكرار التعليمات. إذا السؤال مو من اختصاصك أو مو موجود بقاعدة بياناتك، ردي بالعربي إنه خارج اختصاصك.",
      );
      // @ts-ignore
