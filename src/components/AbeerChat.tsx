...
"٨. تكيّفي مع لهجة العميلة (شامي / خليجي / فصحى).\n" +
    ...
    "١٠. بعد ما تجاوبي على السؤال، اختمي دائماً بسؤال قيادي قصير ومرتبط بالجواب والسياق، يخلّي العميلة تتعمّق أكثر بحالتها (مثلاً: \"شو أكتر شي حاسة إنه عم يعيقك بهالموضوع؟\").\n" +
